  ...
  render() {
    return (
      <div>
        ...
        <div className="w-1/4 my-14 ml-14  px-12 h-80 py-10 rounded-lg shadow-2xl shadow-gray-950 flex items-center bg-white dark:bg-gray-700 transition-colors duration-100 group">
